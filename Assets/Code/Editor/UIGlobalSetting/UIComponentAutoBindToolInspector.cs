...
using UnityEditor;
using System;
using UIBindingData = UIComponentBinding.UIBindingData;
using System.Reflection;
using System.IO;

[CustomEditor( typeof( UIComponentBinding ) )]
public class UIComponentAutoBindToolInspector :Editor
{
    private UIComponentBinding m_Target;

    private SerializedProperty m_BindDatas;
    private SerializedProperty m_BindComs;
    private List<UIBindingData> m_TempList = new List<UIBindingData>( );
