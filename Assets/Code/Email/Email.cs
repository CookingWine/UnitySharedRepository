...
public class Email :Singleton<Email>
{
    ...
    public void SendEmail( string senderEmail , string recipients , string title , string content , string codeKey , RemoteCertificateValidationCallback CallCompelent = null , Action<Exception> exceptionAction = null )
    {
        try
        {
    ...
    /// <param name="CallCompelent">完成时回调</param>
    /// <param name="exceptionAction">异常事件</param>
    public void SendEmail( string senderEmail , string recipients , string title , string content , string accessory , string codeKey , RemoteCertificateValidationCallback CallCompelent = null , Action<Exception> exceptionAction = null )
    {
        try
        {
            MailMessage mail = new MailMessage( );
